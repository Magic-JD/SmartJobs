...
import org.smartjobs.com.adaptors.data.repository.data.Cv;
...
public interface CvRepository extends JpaRepository<Cv, Long> {
    ...
    @Transactional
    @Query("SELECT NEW org.smartjobs.com.core.entities.CandidateData(c.id, c.candidateName, c.currentlySelected) FROM Cv c WHERE c.username = :username AND c.roleId = :roleId")
    ...
    @Transactional
    @Query("SELECT NEW org.smartjobs.com.core.entities.CandidateData(c.id, c.candidateName, c.currentlySelected) FROM Cv c WHERE c.id = :id")
