            ...
            <main>
                ...
                <div>
                    ...
                    <div class="heading landing-text text-small">
                        ...
                        <div class="info">
                            You can start by creating a new role and customising your criteria on the <a hx-get="/roles" hx-swap="innerHtml" hx-target="closest main" hx-trigger="click" class="highlighted">Roles</a> page.
                            Select a criteria you'd like to add and choose your max score - this is the weighting you apply to the criteria. The more important the criteria, the higher the max score!
                            <br/>
                            <br/>
                            You can apply up to 10 criteria per role. For a summary of the scoring rules for each criteria, just hover over the information symbol next to it.
                        </div>
                        <h3 class="text-medium">Add Candidates</h3>
                        <div class="info">
                            Once you're happy with your role criteria, jump to the <a hx-get="/candidates" hx-swap="innerHtml" hx-target="closest main" hx-trigger="click" class="highlighted">Candidates</a> page, where you can upload resumes. Resumes uploaded into the system are anonymised and any information which might indicate age, ethnicity or gender is removed (don't worry, you'll still be able to see their name).
                            <br/>
                            <br/>
                        ...
                        <div class="info">
                            From the <a hx-get="/candidates" hx-swap="innerHtml" hx-target="closest main" hx-trigger="click" class="highlighted">Candidates</a>  page, select the candidates you'd like to analyse and click 'Analyze Selected Candidates'.
                            <br/>
                            <br/>
                            The analysis should take just a few seconds, then you'll be able to see your overall scores and score breakdowns, as well as an explanation for why that score was awarded.             </div>
                        ...
                        <div class="info">
                            Not just yet, but watch this space! We're still in beta, so we're not quite at the level of the finished product just yet.
                            <br/>
                            <br/>
